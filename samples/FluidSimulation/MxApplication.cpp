...
namespace FluidSimulation
{
    ...
    class FluidSimulationApplication : public Application
    {
        ...
        virtual void OnCreate() override
        {
            ...
            vorticityField->Load(nullptr, textureSize.x, textureSize.y, TextureFormat::RGBA32F);

            particleField = GraphicFactory::Create<Texture>();
            particleField->Load(nullptr, textureSize.x, textureSize.y, TextureFormat::RGBA32F);

            particleSwapField = GraphicFactory::Create<Texture>();
            particleSwapField->Load(nullptr, textureSize.x, textureSize.y, TextureFormat::RGBA32F);
        }
