...
C++ example:
@code
#include "Vendors/assimp/Importer.hpp"      // C++ importer interface
#include "Vendors/assimp/scene.h"           // Output data structure
#include "Vendors/assimp/postprocess.h"     // Post processing flags
...
C example:
@code
#include "Vendors/assimp/cimport.h"        // Plain-C interface
#include "Vendors/assimp/scene.h"          // Output data structure
#include "Vendors/assimp/postprocess.h"    // Post processing flags
